node {   
 ...
 //         bat 'ssh -i D:/Work/KeyPairs/Tech-O-Dex-API -n -f ec2-user@ec2-34-200-213-23.compute-1.amazonaws.com "sh -c ''cd ~/; java -jar Tech-O-Dex-0.1.0.jar /dev/null &\'"'
            sshPublisher(publishers: [sshPublisherDesc(configName: 'Tech-O-Dex-API', transfers: [sshTransfer(excludes: '', execCommand: 'ssh -i D:\Work\KeyPairs\Tech-O-Dex-API.pem -n -f ec2-user@ec2-34-200-213-23.compute-1.amazonaws.com "sh -c \'cd ~/; java -jar Tech-O-Dex-0.1.0.jar /dev/null &\\\'"', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '', remoteDirectorySDF: false, removePrefix: '', sourceFiles: ' \'target/*.jar\'')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
